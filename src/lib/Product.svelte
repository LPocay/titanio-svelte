...
<section
	class="relative flex h-screen w-screen flex-col bg-[url(/img/product-bg.png)] px-8 pt-28 pb-8 font-inter text-white md:flex-row md:items-center md:justify-between md:bg-[url(/img/product-big-bg.png)] md:bg-cover md:p-0"
	id="producto"
>
